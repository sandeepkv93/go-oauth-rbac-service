...
func InitializeApp() (*app.App, error) {
	...
	adminHandler := handler.NewAdminHandler(userService, userRepository, roleRepository, permissionRepository, rbacService, permissionResolver, adminListCacheStore, db, configConfig)
	...
	dependencies := provideRouterDependencies(authHandler, userHandler, adminHandler, jwtManager, rbacService, permissionResolver, globalRateLimiterFunc, authRateLimiterFunc, idempotencyMiddlewareFactory, probeRunner, configConfig)
